...
import { FaArrowLeft, FaStar, FaRegStar, FaRegClock } from "react-icons/fa";
      ...
      <div className="content">
        ...
        <div className="register">
          <img
            ...
            alt="Foto de perfil do usuário no github"
          />
          <p>Por Gabriel George</p>

          <div className="date">
            <FaRegClock color="#FF859B" />
